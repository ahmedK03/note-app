          ...
          <Col md={4} className="my-4">
            <div className="note text-secondary p-4">
              ...
              <p>
                ...
                numquam dolores eius asperiores ipsa nihil, itaque dicta et at
                deleniti esse saepe architecto neque necessitatibus quos,
                pariatur consequuntur maxime accusantium.{" "}
              </p>
            </div>
          </Col>
        </Row>
